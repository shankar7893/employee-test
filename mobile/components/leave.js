          ...
          <View style={{ flex: 1, marginLeft: 20, marginRight: 20 }}>
            ...
            >
              <View style={{ flexDirection: "column" }}>
                {this.state.fromDate != "" ? (
                  <Text style={{ fontFamily: "calibri" }}>From</Text>
                ) : null}
                <Card>
                  <CardItem>
                    <TouchableOpacity onPress={this._showFromDateTimePicker}>
                      ...
                      >
                        {this.state.fromDate === "" ? (
                          <Text
                            style={{ fontFamily: "calibri", color: "#cacaca" }}
                          >
                            From{" "}
                          </Text>
                        ) : (
                        ...
                        if (
                          ...
                          if (
                            ...
                            if (this.state.fromDate == "") {
                              Alert.alert(
                                "",
                                "Please set from date and try again",
                                [{ text: "ok" }],
                                { cancelable: false }
                              );
                            }
                        ...
                        if (
                          ...
                          if (
                            ...
                            if (this.state.toDate == "") {
                              Alert.alert(
                                "",
                                "Please set To date and try again",
                                [{ text: "OK" }],
                                { cancelable: false }
                              );
                            }
                          ...
                          alert("Please set From date and reason");
                        }
                        if (
                          !(
                          ...
                          if (
                            ...
                            if (this.state.reason == "") {
                              Alert.alert(
                                "",
                                "Please set reason and try again",
                                [{ text: "OK" }],
                                { cancelable: false }
                              );
                            }
                          ...
                          Alert.alert(
                            "",
                            "Please set From date and To date",
                            [{ text: "OK" }],
                            { cancelable: false }
                          );
                        }
                      } else {
                        Alert.alert("", "Fill all details", [{ text: "OK" }], {
                          cancelable: false
                        });
                      }
                    });
